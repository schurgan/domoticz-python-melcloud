...
"""
<plugin key="MELCloud" version="0.9.0" name="MELCloud plugin" author="gysmo schurgan dalonsic ChatGPT" wikilink="https://github.com/schurgan/domoticz-BSR" externallink="http://www.melcloud.com">
    <params>
