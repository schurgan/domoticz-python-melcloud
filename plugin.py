...
#
# Release Notes:
# v1.0.0: Endversion, code Optimierung/Säuberung.
...
"""
<plugin key="MELCloud" version="0.9.0" name="MELCloud plugin" author="gysmo schurgan dalonsic ChatGPT" externallink="https://github.com/schurgan/domoticz-python-melcloud">
    <params>
...
class BasePlugin:
    ...
    domoticz_levels["mode_pic"] = {"0": 16, "10": 16, "20": 16, "30": 16, "40": 16, "50": 16}
