...
"""
<plugin key="MELCloud" version="0.9.0" name="MELCloud plugin" author="gysmo schurgan dalonsic ChatGPT" wikilink="https://github.com/schurgan/domoticz-python-melcloud" externallink="http://www.melcloud.com">
    <params>
